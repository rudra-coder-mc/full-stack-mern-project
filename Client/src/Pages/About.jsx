...
export default function About() {
  return (
    <div className="bg-blue-200 h-auto flex flex-col items-center justify-center p-8">
      <div className="mb-8">
        <h2 className="text-5xl font-bold mb-4">
          Welcome to Uniq`s Automotive
        </h2>
        <p className="text-lg mb-8 leading-relaxed">
          Uniq1s Automotive is your premier destination for top-quality car
          accessories and automotive services. Our passion for cars drives us to
          deliver exceptional products and services that meet all your
          automotive needs.
        </p>
      </div>
      <div>
        <div className="mb-4">
          ...
          <p className="text-lg leading-relaxed">
            ...
            and reliable car accessories tailored to your style and
            functionality preferences. Additionally, our aim is to provide
            outstanding automotive services that ensure optimal vehicle
        ...
        <div className="mb-4">
          ...
          <p className="text-lg leading-relaxed">
            ...
            wide range of services including car wrapping, custom interior
            design, soundproofing, auto lighting, car detailing, high-end audio
            installation, car restoration, paint protective film, and more. With
            our highly skilled and dedicated team of experts, we are committed
            to serving you efficiently. Our spacious workshop features ample
            parking slots and multiple bays equipped with advanced technology to
