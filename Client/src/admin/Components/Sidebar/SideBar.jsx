...
const SideBar = () => {
  ...
  const handleProductMenuClick = () => {
    ...
    setOpenServiceMenu(false); // Close service submenu if open
  };

  const handleServiceMenuClick = () => {
    setOpenServiceMenu(!openServiceMenu);
    setOpenProductMenu(false); // Close product submenu if open
  };

  return (
    <>
      <div className="w-56 bg-gray-800 h-screen">
        {/* SideBar content */}
        <div className="p-4 text-white">
          ...
          {/* SideBar links */}
          <ul className="mt-3">
            <li className="py-2 hover:bg-gray-700 flex p-2 rounded">
              <svg
              ...
              {openProductMenu && (
                <ul className="w-48 absolute left-full top-0 mt-0 ml-4 bg-gray-700 text-gray-200 rounded">
                  <li className="py-2 hover:bg-gray-600">
                    <NavLink to="/Dashboard/productinsert" className="px-4">
                      Add Product
                    </NavLink>
                  </li>
                  <li className="py-2 hover:bg-gray-600">
                    <NavLink to="/Dashboard/allProducts" className="px-4">
                      All Products
                    </NavLink>
                  </li>
                </ul>
            ...
            <li className="py-2 hover:bg-gray-700 flex p-2 rounded">
              ...
              <NavLink to="/Dashboard/page3" className="mx-2">
                Services
              </NavLink>
              {/* Submenu */}
              {openServiceMenu && (
                <ul className="w-48 absolute left-full top-0 mt-0 ml-4 bg-gray-700 text-gray-200 rounded">
                  <li className="py-2 hover:bg-gray-600">
                    <NavLink to="/Dashboard/addProduct" className="px-4">
                      Add Product
                    </NavLink>
                  </li>
                  <li className="py-2 hover:bg-gray-600">
